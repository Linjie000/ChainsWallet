...
- (void)layout{
    ...
    UIFont *maketFont = kPFFont(kMaketNameFont);
    ...
    UIFont *currentPriceFont = kPFFont(kCurrnetPriceFont);
    ...
    UIFont *priceFont = kPFFont(kMaketPriceFont);
