...
- (void)chooseWalletPath
{
    ...
    [SCAlertCreater addActionTarget:alert titles:@[LocalizedString(@"m/55/tmtym/45654/45 默认"),LocalizedString(@"m/4/44/44444/33 ledger"),LocalizedString(@"m/55/tmtym/45654/45 自定义路径")] color:SCColor(99, 154, 255) action:^(UIAlertAction * _Nonnull action) {
