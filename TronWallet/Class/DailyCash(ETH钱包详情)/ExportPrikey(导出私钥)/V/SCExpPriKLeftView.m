...
@implementation SCExpPriKLeftView
...
- (void)subViews{
    ...
    NSMutableAttributedString *detailText = [[NSMutableAttributedString alloc] initWithString:@"ashrfihrfhooif hohosafasffbbgb23234fihrfhooif asdfasfasfasfa”。" attributes:@{NSKernAttributeName:@(1)}];
