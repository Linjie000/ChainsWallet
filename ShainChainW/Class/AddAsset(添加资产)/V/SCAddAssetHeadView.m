...
- (UITextField *)textField
{
    if (!_textField) {
        ...
        _textField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:LocalizedString(@"输入 Token 名称或合约地址") attributes:@{NSFontAttributeName:kFont(15),NSForegroundColorAttributeName:SCGray(128)}];
