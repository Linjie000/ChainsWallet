...
@property(strong, nonatomic) SCBSJNewsLayout *bsjLayout;
@property(strong, nonatomic) SCBSJSearchLayout *searchLayout;
@property(strong, nonatomic) SCBitCoin86Layout *bitCoin86Layout;
