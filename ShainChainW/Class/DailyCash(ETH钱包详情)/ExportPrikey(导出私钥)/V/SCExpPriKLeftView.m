...
- (void)setPriKey:(NSString *)priKey
{
    ...
    NSMutableAttributedString *detailText = [[NSMutableAttributedString alloc] initWithString:_priKey attributes:@{NSKernAttributeName:@(1)}];
...
- (void)subViews{
    ...
    [lab setTapActionWithBlock:^{
        [RewardHelper copyToPastboard:weakSelf.priKey];
    }];
