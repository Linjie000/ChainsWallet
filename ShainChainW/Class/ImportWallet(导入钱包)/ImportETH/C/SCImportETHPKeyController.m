...
@interface SCImportETHPKeyController ()
...
@implementation SCImportETHPKeyController
...
- (void)createIDAction
{
    ...
    [HSEther hs_importWalletForPrivateKey:private pwd:pwd block:^(NSString *address, NSString *keyStore, NSString *mnemonicPhrase, NSString *privateKey, BOOL suc, HSWalletError error) {
        if (suc) {
