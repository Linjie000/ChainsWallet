...
@property(nonatomic , assign) CGFloat navigationBarCenterY;
...
-(void)videoRotate:(NSNotification *)notification
{
    if (self.navigationController.navigationBar.frame.origin.y != self.navigationBarCenterY) {
        CGRect frame = self.navigationController.navigationBar.frame;
        frame.origin.y = self.navigationBarCenterY;
